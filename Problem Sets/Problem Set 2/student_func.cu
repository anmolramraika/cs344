                      ...
                      unsigned char* const blueChannel)
{
  ...
  uchar4 inputImage = inputImageRGBA[thread_1D_pos];
  redChannel[thread_1D_pos] = inputImage.x;
  greenChannel[thread_1D_pos] = inputImage.y;
  blueChannel[thread_1D_pos] = inputImage.z;
}
